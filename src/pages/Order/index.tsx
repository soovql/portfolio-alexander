...
const Order: React.FC<Props> = (props) => {
    ...
    return (
        <div
            ...
            // @todo change
            style={{backgroundImage: "linear-gradient(175deg, rgba(122,122,122,0.6446953781512605) 35%, rgba(255,255,255,0) 100%)", backgroundColor: "#fff"}}
        >
            <Cursor />
            <Logo
            ...
            <div className={rootClass('wrapper')}>
                ...
                <div className={rootClass('content')}>
                    <section className={rootClass('wrapper')}>
                        ...
                        <div className={rootClass('text')}>
                            Просто напишите в&nbsp;мессенджере какой вариант вам
                            нравится и&nbsp;я&nbsp;помогу в&nbsp;оформлении.
                        </div>
                    ...
                    <section className={rootClass('wrapper')}>
                        ...
                        <div className={rootClass('text')}>
                            ...
                            (включая аэросъемку и&nbsp;360) интерьеров городских lifestyle сюжетов
                        </div>
                    ...
                    <section className={rootClass('wrapper')}>
                        ...
                        <div className={rootClass('text')}>
                            ...
                            готов проводить подобные истории. Но&nbsp;ничто не&nbsp;мешает нам с&nbsp;вами встретиться в&nbsp;Москве,
                            чтобы я&nbsp;показал живописные и&nbsp;не&nbsp;самые очевидные уголки города.
                        </div>
                    ...
                    <section className={rootClass('wrapper')}>
                        ...
                        <div className={rootClass('text')}>
                            ...
                            Также я&nbsp;уже 10&nbsp;лет занимаюсь <span>маркетингом</span> и&nbsp;оказываю консальтуционные услуги.
                        </div>
